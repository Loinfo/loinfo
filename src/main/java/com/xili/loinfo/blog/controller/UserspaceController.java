...
import com.xili.loinfo.blog.service.BlogService;
...
public class UserspaceController {
    ...
    public String saveProfile(@PathVariable("username") String username, User user) {
        ...
        String encodPwd = encoder.encode(user.getPassword());
        boolean isMatch = encoder.matches(rawPassword, encodPwd);
        if (!isMatch) {
    ...
    @PreAuthorize("authentication.name.equals(#username)")
    public ResponseEntity<Response> saveAveAvatar(@PathVariable("username") String username, @RequestBody User user) {
